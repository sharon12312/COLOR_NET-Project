...
# Load Train32
image = img_to_array(load_img('./Images/image_00004.jpg'))
image = np.array(image, dtype=float)
X = rgb2lab(1.0/255*image)[:,:,0]
X = X.reshape(1, 32, 32, 1)

# Open image with Image object for resize later
img = Image.open('./Images/image_00004.jpg')
...
new_img = img.resize((96, 96), Image.ANTIALIAS).filter(ImageFilter.SHARPEN)
...
imsave("./Results/img_result8.jpg", lab2rgb(cur))